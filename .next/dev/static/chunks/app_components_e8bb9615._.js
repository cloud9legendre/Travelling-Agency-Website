...
_s(Navbar, "GX9qRuL9Xe1uhJtlvEJyPqFnFUQ=");
_c = Navbar;
var _c;
...
function ClientLoader({ children }) {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "ClientLoader.useEffect": ()=>{
            ...
            }["ClientLoader.useEffect.showTimer"], 50);
            const hideTimer = setTimeout({
                "ClientLoader.useEffect.hideTimer": ()=>setLoading(false)
            }["ClientLoader.useEffect.hideTimer"], 3000); // Minimum loader duration
            return ({
                "ClientLoader.useEffect": ()=>{
...
//# sourceMappingURL=app_components_e8bb9615._.js.map